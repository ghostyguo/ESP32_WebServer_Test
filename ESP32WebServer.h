/*
  ESP23WebServer.h - Dead simple web-server.
  Supports only one simultaneous client, knows how to handle GET and POST.
  FS of ESP32 is SD and is not supported in current version.
...
public:
  ...
  //void serveStatic(const char* uri, fs::FS& fs, const char* path, const char* cache_header = NULL );  //currently not supported 
  void onNotFound(THandlerFunction fn);  //called when handler is not assigned
  //void onFileUpload(THandlerFunction fn); //handle file uploads,  //currently not supported 
